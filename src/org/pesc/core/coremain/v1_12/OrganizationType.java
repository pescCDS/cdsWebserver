 ...
 *         &lt;element name="OrganizationName" type="{urn:org:pesc:core:CoreMain:v1.12.0}OrganizationNameType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlSeeAlso({
    GuarantorType.class,
    LenderType.class,
    BorrowerpreferredLenderType.class
})
