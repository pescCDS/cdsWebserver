...
@Repository
public class FilterSetsDaoImpl extends AbstractDaoImpl<FilterSet> implements FilterSetsDao {
	private static final Log log = LogFactory.getLog(FilterSetsDaoImpl.class);
