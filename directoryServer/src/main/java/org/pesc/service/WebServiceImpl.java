...
@javax.jws.WebService(portName = "SoapPort", serviceName = "DirectoryService",
        targetNamespace = "http://org.pesc.cds",
        endpointInterface = "org.pesc.cds.webservice.WebServicesInterface")
public class WebServiceImpl implements WebServicesInterface {
    ...
    public List<Organization> organizationListRequest(String organizationNameSearchString) throws ServletException {
        try {
            ...
            organization.setOrganizationName("Butte College");
