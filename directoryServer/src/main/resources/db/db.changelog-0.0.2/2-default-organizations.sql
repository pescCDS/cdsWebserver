...
INSERT INTO organization (name, street, city, state, zip, website, created_time, modified_time, telephone, active, enabled) VALUES
('Butte College', '3536 Butte Campus Dr.', 'Oroville', 'CA', '95965', 'http://www.butte.edu/', NOW(), NOW(), '(530) 895-2511', true, true);

INSERT INTO organization (name, street, city, state, zip, website, created_time, modified_time, telephone, active, enabled) VALUES
('Parchment, Inc.', '3000 Lava Ridge Ct.', 'Roseville', 'CA', '95965', 'http://www.parchment.com/', NOW(), NOW(), '(530) 895-2511', true, true);
